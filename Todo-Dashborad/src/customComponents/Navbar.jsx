...
const Navbar = ({ onLeftToggle, onRightToggle }) => {
        ...
        <div className='border-b border-gray-300 py-3'>
            <div className='max-w-[1300px] w-full px-4 md:px-0 md:mx-auto flex items-center justify-between'>
                <div className='flex-1'>
                    ...
                    <p className="md:hidden"><IoMdMenu onClick={onLeftToggle} size="20" /></p>
                </div>
                ...
                <div className='flex flex-1 items-center gap-0.5 justify-end'>
                    ...
                    <p className="block md:hidden"><SiGoogleanalytics onClick={onRightToggle} size="20" /></p>
                </div>
            </div>
        </div>
    )
